...
"""
    ...
    CAREFUL! Delete first of all the readme.md file in imgs folder if you have just downloaded it!!
"""
...
class Flickr30kImages(Dataset):
    ...
    def __getitem__(self, idx):
        image_name = os.path.join(self.root_dir + '/Flickr30k/imgs', self.image_names[idx])
...
def get_feature_map_rcnn(cfg, processFeatures='mean_pool2d'):
    ...
    for split in ['train', 'val', 'test']:
        ...
        with open("../../data/Flickr30k/" + split + '_FasterRCNN_features.pkl', 'wb') as f:
            pickle.dump(all_features, f)


if __name__== "__main__":
    cfg = initialise()
    get_feature_map_rcnn(cfg, processFeatures='mean_pool2d')
    print('finished')